...
@app_var.route('/reset_password_request', methods=['GET', 'POST'])
...
@app_var.route('/reset_password/<token>', methods=['GET', 'POST'])
...
@app_var.route('/unfollow/<username>')
@login_required
def unfollow(username):
    ...
    db.session.commit()
    flash("Your aren't following {}.".format(username))
    return redirect(url_for('user', username=username))
